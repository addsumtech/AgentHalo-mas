...
const DOCK_ICON_SOURCE = path.join(ROOT, "assets", "source", "agenthalo", "icon-master.png");
...
test("AgentHalo icon master is preserved for regeneration", () => {
  assert.ok(
    fs.existsSync(DOCK_ICON_SOURCE),
    "assets/source/agenthalo/icon-master.png should exist as the regeneration source"
  );
});
