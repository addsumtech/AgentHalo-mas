...
themeLoader.init(path.join(__dirname, "legacy-app", "src"));

const BUILTINS = [
  { id: "clawd", theme: path.join(__dirname, "legacy-app", "themes", "clawd", "theme.json"), assets: path.join(ROOT, "assets", "svg") },
  { id: "cloudling", theme: path.join(__dirname, "legacy-app", "themes", "cloudling", "theme.json"), assets: path.join(__dirname, "legacy-app", "themes", "cloudling", "assets") },
];
