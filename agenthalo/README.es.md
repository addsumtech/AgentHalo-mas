...
[English](README.md) · [简体中文](README.zh-CN.md) · [繁體中文](README.zh-TW.md) · [日本語](README.ja-JP.md) · [한국어](README.ko-KR.md) · Español
...
Basado en [Clawd on Desk](https://github.com/rullerzhou-afk/clawd-on-desk). Gracias a Ruller_Lulu y a los colaboradores del proyecto original.
