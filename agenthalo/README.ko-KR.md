...
AgentHalo는 작업 중이거나 대기 중인 기본 작업을 표시하고, 클릭하면 해당 작업으로 돌아갑니다. 애니메이션과 소리가 포함된 캐릭터 18종(오리지널 17종과 손오공)을 제공하며 백그라운드 하위 작업은 목록에 표시하지 않습니다.

Mac App Store 버전입니다. 포함된 기능은 [스토어 버전 안내](../README.md)를 참조하세요.
