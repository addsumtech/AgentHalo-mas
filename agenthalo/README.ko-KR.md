...
<img src="assets/icon.png" width="128" alt="AgentHalo">

[English](README.md) · [简体中文](README.zh-CN.md) · [繁體中文](README.zh-TW.md) · [日本語](README.ja-JP.md) · [한국어](README.ko-KR.md) · [Español](README.es.md)

AI 작업을 함께하는 조용한 데스크톱 친구.

AgentHalo는 작업 중이거나 대기 중인 기본 작업을 표시하고, 클릭하면 해당 작업으로 돌아갑니다. 애니메이션과 소리가 포함된 캐릭터 20종을 제공하며 백그라운드 하위 작업은 목록에 표시하지 않습니다.

현재 연동 기능은 [프로젝트 안내](../README.md), 실제 검증 범위는 [검증 기록](../docs/INTEGRATION-FIXES-2026-09-07.md)을 참조하세요.
...
[AgentHalo Issues](https://github.com/addsumtech/AgentHalo/issues)

## 감사의 말

[Clawd on Desk](https://github.com/rullerzhou-afk/clawd-on-desk)를 기반으로 개발했습니다. Ruller_Lulu와 원본 프로젝트 기여자들에게 감사합니다.

[AGPL-3.0-only](LICENSE) · [NOTICE.md](NOTICE.md)
