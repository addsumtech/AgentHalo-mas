...
const DEFAULT_TG_APPROVAL = Object.freeze({
  ...
  allowedTgUserId: "",
  targetSessionKey: "",
  // R1a bare ping gate: when false, AgentHalo will not send a "finished" message.
...
// that path pulled the token value into AgentHalo's main process and violated the
