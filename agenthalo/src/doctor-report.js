...
function formatDiagnosticReport(result, meta = {}) {
  ...
  const lines = [
    "# AgentHalo Diagnostic Report",
    "",
    `- Generated: ${generatedAt}`,
    `- AgentHalo version: ${version}`,
  ...
  lines.push(
    "",
    "**Privacy notice**: This report is generated locally. AgentHalo does not upload any data. User paths are replaced with `~`, and AgentHalo app paths are replaced with `[APP]`. The report contains no API keys, tokens, conversation content, or document filenames."
  );
