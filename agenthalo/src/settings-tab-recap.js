...
(function initSettingsTabRecap(root) {
  ...
  const KNOWN_AGENT_COLORS = Object.freeze({
    ...
    workbuddy: "var(--recap-agent-workbuddy)",
    "deepseek-harness": "var(--recap-agent-deepseek-harness)",
    "copilot-cli": "var(--recap-agent-copilot-cli)",
    "antigravity-cli": "var(--recap-agent-antigravity-cli)",
    "cursor-agent": "var(--recap-agent-cursor-agent)",
    "codebuddy": "var(--recap-agent-codebuddy)",
    "kiro-cli": "var(--recap-agent-kiro-cli)",
    "kimi-cli": "var(--recap-agent-kimi-cli)",
    "qwen-code": "var(--recap-agent-qwen-code)",
    "zcode": "var(--recap-agent-zcode)",
    "mimocode": "var(--recap-agent-mimocode)",
    "pi": "var(--recap-agent-pi)",
    "openclaw": "var(--recap-agent-openclaw)",
    "hermes": "var(--recap-agent-hermes)",
    "qoder": "var(--recap-agent-qoder)",
    "reasonix": "var(--recap-agent-reasonix)",
    "qoderwork": "var(--recap-agent-qoderwork)",
    "qwenwork": "var(--recap-agent-qwenwork)",
    "traecode": "var(--recap-agent-traecode)",
  });
