...
(function initSettingsTabTelegramApproval(root) {
  ...
  // Connection failures AgentHalo raises itself. Anything not listed here came from
  ...
  // connection, or button presses never reach AgentHalo (#493). The header states
