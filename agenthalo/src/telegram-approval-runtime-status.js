...
const STATUS_LOCALES = Object.freeze({
  en: {
    title: "AgentHalo Telegram status",
    labels: {
      transport: "Transport",
      health: "Health",
  ...
  ja: {
    title: "AgentHalo Telegram ステータス",
    labels: {
      transport: "送信方式",
      health: "状態",
  ...
  "pt-BR": {
    title: "Status do Telegram no AgentHalo",
    labels: {
  ...
  es: {
    title: "Estado de Telegram en AgentHalo",
    labels: {
      transport: "Transporte",
      health: "Estado",
