...
(function initSettingsTabAnimOverrides(root) {
  ...
  function buildAnimOverrideThemeMeta(data) {
    ...
    const themeName = root.AgentHaloLocalizedField.localizeField(
      data.theme && data.theme.name,
      readers.getLang()
    );
    themeLabel.textContent = `${t("animOverridesCurrentTheme")}: ${themeName || "AgentHalo"}`;
