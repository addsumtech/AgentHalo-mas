...
function registerAntigravityHooks(options = {}) {
  ...
  if (!options.configPath && !hasAntigravityConfig(homeDir)) {
    if (!options.silent) console.log("AgentHalo: Antigravity config not found - skipping Antigravity hook registration");
...
function registerAntigravityStatusline(options = {}) {
  ...
  if (!options.settingsPath && !hasAntigravityStatuslineSettings(homeDir)) {
    if (!options.silent) console.log("AgentHalo: Antigravity CLI settings not found - skipping statusline registration");
