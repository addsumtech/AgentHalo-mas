...
AgentHalo 顯示工作中和等待中的主任務，點擊即可回到對應任務。內含 18 個角色（17 個原創夥伴和孫悟空），各有動畫與聲音，背景子任務不單獨顯示。

這是 Mac App Store 版，包含哪些功能見[商店版說明](../README.md)。
...
基於 [Clawd on Desk](https://github.com/rullerzhou-afk/clawd-on-desk) 繼續開發，感謝 Ruller_Lulu 與原專案貢獻者。
