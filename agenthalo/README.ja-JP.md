...
AgentHalo は作業中と待機中のメインタスクを表示し、クリックしたタスクに戻れます。アニメーションと音声付きのキャラクターを 18 種類収録（オリジナル 17 種と孫悟空）。バックグラウンドの子タスクは一覧に表示しません。

これは Mac App Store 版です。含まれる機能は[ストア版の説明](../README.md)を参照してください。
