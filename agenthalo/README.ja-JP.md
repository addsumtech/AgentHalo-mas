...
AI の作業を見守る、静かなデスクトップの仲間。

AgentHalo は作業中と待機中のメインタスクを表示し、クリックしたタスクに戻れます。アニメーションと音声付きのキャラクターを 20 種類収録。バックグラウンドの子タスクは一覧に表示しません。

対応状況は[プロジェクトの説明](../README.md)、検証範囲は[検証記録](../docs/INTEGRATION-FIXES-2026-09-07.md)を参照してください。
...
[Clawd on Desk](https://github.com/rullerzhou-afk/clawd-on-desk) をもとに開発しています。Ruller_Lulu と元プロジェクトの貢献者に感謝します。
