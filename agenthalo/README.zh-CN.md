...
AgentHalo 显示工作中和等待中的主任务，点击即可回到对应任务。内含 20 套角色、动画和声音，后台子任务不单独显示。

当前接入能力见[仓库说明](../README.md)，实际验证范围见[验证记录](../docs/INTEGRATION-FIXES-2026-09-07.md)。
...
基于 [Clawd on Desk](https://github.com/rullerzhou-afk/clawd-on-desk) 继续开发，感谢 Ruller_Lulu（鹿鹿）及原项目贡献者。
